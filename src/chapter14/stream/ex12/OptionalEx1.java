...
//        System.out.println(optInt2.getAsInt());             // NoSuchElementException
        System.out.println("optInt1="+optInt1);               // 1
        System.out.println("optInt2="+optInt2);               // 1
    ...
    static int optStrToInt(Optional<String> optStr, int defaultVal) {
        try {
